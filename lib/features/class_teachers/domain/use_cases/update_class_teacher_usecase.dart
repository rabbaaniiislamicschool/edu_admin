...
@injectable
class UpdateClassTeacherUseCase implements UseCase<void, ClassTeacher>{
  final ClassTeacherRepository _repository;

  UpdateClassTeacherUseCase(this._repository);

  @override
  Future<Either<Failure, void>> execute(ClassTeacher params) {
    return _repository.updateClassTeacher(params);
  }
